# Relatório Técnico Individual - PC 3 - VM 2

## 🖥️ Informações Gerais da Máquina
* **Responsável pelo Teste:** Henrique
* **Hostname:** g9-pc3-vm2
* **FQDN:** g9-pc3-vm2.grupo9.bsi-26-1.maceio.lab
* **IP Dedicado:** 192.168.26.134
...
1. **Teste 1: Ping por IP** (Alvo: VM 7)
```bash
ping -c 2 192.168.26.135
```

2. **Teste 2: Ping por Hostname** (Alvo: VM 8)
```bash
ping -c 2 g9-pc4-vm2
```

3. **Teste 3: Ping por FQDN** (Alvo: VM 1)
```bash
...
```bash
ssh henrique.carvalho@g9-pc2-vm1
```
