...
# Relatório Técnico Individual - PC 1 - VM 1

## 🖥️ Informações Gerais da Máquina
* **Responsável pelo Teste:** Eduardo
* **Hostname:** g9-pc1-vm1
* **FQDN:** g9-pc1-vm1.grupo9.bsi-26-1.maceio.lab
* **IP Dedicado:** 192.168.26.129
...
1. **Teste 1: Ping por IP** (Alvo: VM 2)
```bash
ping -c 2 192.168.26.130
```

2. **Teste 2: Ping por Hostname** (Alvo: VM 3)
```bash
ping -c 2 g9-pc2-vm1
```

3. **Teste 3: Ping por FQDN** (Alvo: VM 4)
```bash
ping -c 2 g9-pc2-vm2.grupo9.bsi-26-1.maceio.lab
```
...
4. **Teste 4: SSH por IP** (Alvo: VM 5 | Usuário: administrador)
```bash
ssh administrador@192.168.26.133
```

*<p align="center">Figura 3: Retorno do teste SSH por IP.</p>*![Retorno do teste SSH por IP](./ssh-ip.png)

5. **Teste 5: SSH por Hostname** (Alvo: VM 6 | Usuário: henrique.carvalho)
```bash
ssh henrique.carvalho@g9-pc3-vm2
```

*<p align="center">Figura 3: Retorno do teste SSH por Hostname.</p>*![Retorno do teste SSH por Hostname](./ssh-hostname.png)

5. **Teste 6: Script de testes**
```bash
