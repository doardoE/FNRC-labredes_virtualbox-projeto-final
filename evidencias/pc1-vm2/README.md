# Relatório Técnico Individual - PC 1 - VM 2

## 🖥️ Informações Gerais da Máquina
* **Responsável pelo Teste:** Eduardo
* **Hostname:** g9-pc1-vm2
* **FQDN:** g9-pc1-vm2.grupo9.bsi-26-1.maceio.lab
* **IP Dedicado:** 192.168.26.130
...
1. **Teste 1: Ping por IP** (Alvo: VM 3)
```bash
ping -c 2 192.168.26.131
```

2. **Teste 2: Ping por Hostname** (Alvo: VM 4)
```bash
ping -c 2 g9-pc2-vm2
```

3. **Teste 3: Ping por FQDN** (Alvo: VM 5)
```bash
ping -c 2 g9-pc3-vm1.grupo9.bsi-26-1.maceio.lab
```
...
4. **Teste 4: SSH por IP** (Alvo: VM 6 | Usuário: eduardo.calado)
```bash
ssh eduardo.calado@192.168.26.134
```

*<p align="center">Figura 3: Retorno do teste SSH por IP.</p>*![Retorno do teste SSH por IP](./ssh-ip.png)

5. **Teste 5: SSH por Hostname** (Alvo: VM 7 | Usuário: cirilo.silva)
```bash
ssh cirilo.silva@g9-pc4-vm1
```
